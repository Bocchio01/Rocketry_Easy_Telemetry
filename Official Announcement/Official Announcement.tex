...
\backgroundsetup{
    ...
    opacity=0.01,
    angle=0,
    contents={\includegraphics[width=0.6\paperwidth]{Rocket background.pdf}}
}
...
\textbf{L'evento si terrà il \dateitalian{21/07/2023} con inizio alle 17:00.} Se tutto va bene, il lancio del primo razzo avverrà verso le 18:00.
